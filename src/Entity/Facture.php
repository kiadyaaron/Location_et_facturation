...
class Facture
{
    ...
    public function getMoisFacture(): ?\DateTimeImmutable { return $this->moisFacture; }
    public function setMoisFacture(\DateTimeImmutable $mois): self { $this->moisFacture = $mois; return $this; }
